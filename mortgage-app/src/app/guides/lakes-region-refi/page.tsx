...
export default function LakesRegionRefiGuide() {
  return (
    <main style={{ padding: '8rem 15%', minHeight: '100vh', background: 'white', color: 'hsl(var(--nh-slate))', lineHeight: '1.8' }}>
      ...
      <h2 className="display-font" style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>2. Seasonal Income Considerations</h2>
      ...
      <div style={{ padding: '3rem', border: '1px solid #f1f5f9', borderRadius: '24px', background: 'hsla(var(--nh-gold), 0.05)' }}>
        <h2 style={{ marginBottom: '1.5rem' }}>3. Jumbo Loan Refinancing in Belknap County</h2>
        <p>
